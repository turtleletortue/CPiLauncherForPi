...
#                print(colour_opts)
    ...
    def GiveIcon(self,orig_file_or_dir): ## return is string,not Surface
        #doing a wrapper for items under /home/pi/apps/Menu/*, to be like Menu/GameShell/*
        if orig_file_or_dir.startswith("/home/pi/apps/Menu"):
            orig_file_or_dir = orig_file_or_dir.replace("/home/pi/apps/Menu/","../Menu/GameShell/")
